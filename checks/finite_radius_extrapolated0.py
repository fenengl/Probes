...
###### V=3.5
    ...
    if (alpha <= tol) and (1/kappa <= tol):
        ...
        plt.scatter(67.7,-2.5325807804984185e-05/I0,marker='o',c='green',label='PUNC++'))

        #plt.scatter(eta[indices_p],-1.288656E-05/I0,marker='o',c='orange')
        #plt.scatter(27,-1.299920E-05/I0,marker='o',c='orange')
