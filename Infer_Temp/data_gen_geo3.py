...
def random_synthetic_data(N,geo1,geo2,geo3,model1, model2,Vs_geo1,Vs_geo2,Vs_geo3,geometry):
    ...
    for i, n, T, V0 in zip(count(), ns, Ts, tqdm(V0s)):
        ...
        Is_geo3[i] = model2(geo3, l.Electron(n=n, T=T), V=V0+Vs_geo3)
    Istemp=np.append(Is_geo1,Is_geo2,axis=1)
    Is=np.append(Istemp,Is_geo3,axis=1)
    ...
    if geometry=='cylinder':
        ...
        synth_data.to_csv('synth_data_mNLPs.csv')
