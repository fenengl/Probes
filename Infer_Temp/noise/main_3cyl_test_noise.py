...
if TF == True:
    ...
    plt.savefig('history_ctest.png', bbox_inches="tight")
    plt.show()
elif TF == False:
...
data_geo1 = d.generate_synthetic_data(geo1, Vs_geo1, model=model1,noise=sel_noise)
data_geo2 = d.generate_synthetic_data(geo2, Vs_geo2, model=model2,noise=sel_noise)
...
plt.title('a)')
plt.legend()
plt.savefig('predict_1_test.png', bbox_inches="tight")
