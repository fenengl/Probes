...
if TF == True:
    ...
    net_model.save('tf_model_test_%i'%version)
    ...
    plt.savefig('history_test_c.png', bbox_inches="tight")
    plt.show()
elif TF == False:
...
data_geo1 = d.generate_synthetic_data(geo1, Vs_geo1,noise=sel_noise, model=model1)
data_geo2 = d.generate_synthetic_data(geo2, Vs_geo2,noise=sel_noise, model=model2)
...
plt.title('c)')
plt.legend()
plt.savefig('predict_3_test.png', bbox_inches="tight")
