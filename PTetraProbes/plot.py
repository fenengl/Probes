...
if args.OML or args.FR or args.FRE:
    ...
    if args.OML:
        print("Error:              {:.2f}% with OML".format(100*(last_value-comparison_value)/comparison_value, "%"))
        plt.axhline(comparison_value, linestyle='--', color='k', label='Comparison OML')
    elif args.FR:
        print("Error:              {:.2f}% with FR".format(100*(last_value-comparison_value)/comparison_value, "%"))
        plt.axhline(comparison_value, linestyle='--', color='k', label='Comparison FR')
    else:
